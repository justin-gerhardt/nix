[
  ...
  {
    goPackagePath = "cloud.google.com/go/compute/metadata";
    fetch = {
      type = "git";
      url = "https://code.googlesource.com/gocloud";
      rev = "v0.57.0";
  ...
  }
  {
    ...
    fetch = {
      ...
      url = "https://code.googlesource.com/gocloud";
      rev = "bigquery/v1.7.0";
      sha256 = "0y3b901hrkf3fmnw5jy3ac2cbf8kp4w20a3mz5ifbkblmmr0iv1i";
    };
  }
  {
  ...
  {
    goPackagePath = "github.com/Azure/go-autorest/autorest/to";
    fetch = {
      type = "git";
      url = "https://github.com/Azure/go-autorest";
      rev = "autorest/to/v0.3.0";
  ...
  }
  {
    ...
    fetch = {
      type = "git";
      url = "https://github.com/Azure/go-autorest";
      rev = "autorest/v0.10.2";
      sha256 = "08ymwf44lfj4d81g8x919knid5vklnjsvf4lhjpa1zngx3zkbsp2";
    };
  }
  {
    ...
    fetch = {
      type = "git";
      url = "https://github.com/Azure/go-autorest";
      rev = "autorest/adal/v0.8.2";
      sha256 = "03y8p21xfmr6djcay5aa5vs76dcs74l0qvlhmachjp6wl7jf69wr";
    };
  }
  {
    ...
    fetch = {
      ...
      url = "https://code.googlesource.com/gocloud";
      rev = "storage/v1.8.0";
      sha256 = "16z6rgmsy0bmlixpc2901gn8vxqf4g6k5r0fsii8phwh3m4dy6na";
    };
  }
  {
